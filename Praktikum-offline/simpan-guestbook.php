...
include "koneksi.php";
if (isset($_POST['tanggal']) && isset($_POST['name']) && isset($_POST['email']) && isset($_POST['address']) && isset($_POST['username']) && isset($_POST['password'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            ...
            header('location: login.php?status=Selamat datang $nama pada hari ini ');
        } else {
